...
2025년을 기점으로 서울 청년들의 정신건강 문제는 여러 지표를 통해 심각한 수준임이 확인되었습니다. '새싹'은 이러한 문제에 직접 대응하기 위해 설계되었습니다.

| 지표 | 2025년 최신 현황 | 출처 |
|------|------|------|
| **청년 우울증** | 10년 만에 청년기 우울증 환자 수 3배 증가 (2014년 11만 명 → 2024년 36만 명) | KBS뉴스 (2025.06) |
| **1인가구 고립** | 서울시 1인가구 비율 42% 육박 예상 (전국 최고 수준) | 열린뉴스통신 (2025.01) |
| **정신건강 서비스 접근성** | 서울시민 72.1%가 정신건강 어려움 경험, 전문가 도움 받은 비율은 18.8%에 불과 | 서울시정신건강복지센터 (2025.11) |
| **사회적 낙인** | 정신건강 문제를 스스로 해결하려는 응답 45.6% (낙인 우려로 전문 상담 기피) | 서울시정신건강복지센터 (2025.11) |
| **디지털 세대 선호도** | 청년층 중심으로 비대면 소통 선호, 정부 정책도 디지털 기반 지원 강화 추세 | 보건복지부, 서울시 청년정책 |

### 💡 Saessak의 혁신: 데이터 기반의 즉각적이고 신뢰할 수 있는 솔루션

**"24시간 접근 가능한 AI 마음건강 인프라 구축"**

'새싹'은 최신 데이터를 통해 입증된 심각한 문제에 대응하기 위해 다음과 같은 혁신적인 해결책을 제공합니다.

1. **즉각적인 정서 지원**: 정신건강 서비스의 대기 시간 없이, 필요할 때 언제든 대화가 가능합니다. 이는 전문 기관의 도움을 받지 못하는 대다수 시민(81.2%)에게 중요한 대안이 될 수 있습니다.
2. **완벽한 익명성 보장**: 정신질환에 대한 사회적 낙인 때문에 상담을 주저하는 경향(스스로 해결하려는 응답 45.6%)이 여전히 높습니다. '새싹'은 익명성이 보장된 안전한 공간을 제공하여 이러한 장벽을 낮춥니다.
3. **서울의 정체성을 담은 신뢰**: 서울의 수호신 '해치' 캐릭터를 활용하여 시민들에게 친근함과 문화적 유대감을 형성하고, 공공 서비스로서의 신뢰도를 높입니다.

---

## 📖 서비스 개요

**새싹**은 서울의 600년 수호신 **해치**를 AI로 재해석한 디지털 마음건강 동반자입니다. 
...
'새싹'은 서울시가 추진하는 다양한 스마트 도시 및 정신건강 정책과 완벽하게 연계될 수 있습니다.

### 1. 「서울 AI 기본계획」 실현

| 정책 목표 | Saessak 기여 방안 |
|-----------|------------------|
| **AI 일상화** | 시민들이 자연스럽게 AI와 대화하며 정신건강 관리, AI 리터러시 향상 |
| **신뢰할 수 있는 AI** | 100% 로컬 데이터 저장, 투명한 감정 분석 공개로 시민 데이터 주권 보장 |

### 2. 「서울 청년 마음건강 지원사업」 보완

- **청년 정신건강검진 연계**: 2025년부터 2년으로 단축된 검진 주기와 연계하여, 검진 전후의 일상적 관리 지원
- **예방적 케어 시스템**: 위기 징후 조기 발견 및 전문 기관 연계 시스템 구축
- **온라인 청년센터 디지털 확장**: 기존 오프라인 센터의 24시간 디지털 보완재 역할
